  ...
  return (
    <div className="relative overflow-hidden rounded-2xl card-blur p-6 sm:p-10">
      ...
      <div className="flex items-start justify-between gap-6 relative">
        <div>
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-semibold gradient-text">
            {title}
          </h1>
          {subtitle ? (
            <p className="mt-2 text-sm sm:text-base text-black/70 dark:text-white/70 max-w-xl">
              {subtitle}
            </p>
          ) : null}
        </div>
